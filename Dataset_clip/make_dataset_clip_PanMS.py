...
satellite = 'GF1' #'wv2'wv3 8波段以外没区别
...
input_ms_path = glob.glob(os.path.join(input_data_path, "ms", "*.TIF"))#r'./ms.tif'  "ms""pan"是文件夹名
...
# 2304 is for scale 6
clip_size = 1024 #1024#256#128#50 #112
scale = 4 # 6
isRandom = False
align_by_geo = True
...
save_path = os.path.join(input_data_path, 'TifClipPanMS1024')
